...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white navbar-laravel shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}" title="สำนักกฎหมาย ฮาฟิต บินสาอิ ทนายความ">
                    <img src="{{ asset('dist/img/lawyer-icon.png') }}" width="20px"/>
                    สำนักกฎหมาย ฮาฟิต บินสาอิ ทนายความ
